classdef FourierEmbeddingLayerExponential < nnet.layer.Layer % ...
    ...
    methods
        function obj = FourierEmbeddingLayerExponential(numFourierComponents)
        ...
        function [Z ] = predict(obj,X)
            ...
            a = 2.^(0 : (obj.numFourierComponents-1));
