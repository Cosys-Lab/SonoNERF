...
% Function changed eRTIS_Sensor_Overlay from e2s to euc2sph_dist
% Function changed eRTIS_Sensor_Overlay from s2e to sph2euc_dist
% Function changed eRTIS_Sensor_Overlay from s2x to polar2cart
% Function changed eRTIS_Sensor_Overlay from x2s2 to cart2polar2
